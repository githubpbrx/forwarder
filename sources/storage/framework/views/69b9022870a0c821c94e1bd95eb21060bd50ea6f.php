                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="namefwd" name="namefwd"
                                            value="<?php echo e($namafwd); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        var oTable = $('#serverside').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo e(url('privilege/fwd_access/datatablefwd')); ?>',
            },
        ...
        $('body').on('click', '#edituserfwd', function() {
            ...
            $.ajax({
                url: "<?php echo url('privilege/fwd_access/edituserfwd'); ?>",
                type: 'POST',
                dataType: 'json',
                data: {
        ...
        $('#submitbtn').click(function(e) {
            ...
            if (emailuser == null || emailuser == '') {
                ...
                $.ajax({
                    type: "post",
                    url: (id == '') ? "<?php echo e(url('privilege/fwd_access/saveuserfwd')); ?>" :
                        "<?php echo e(url('privilege/fwd_access/updateuserfwd')); ?>",
                    data: {
                        _token: $('meta[name=csrf-token]').attr('content'),
                        id: id,
                        emailuser: emailuser,
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            //     .replace("<?php echo e(url('privilege/accessfwd')); ?>"):
                            //     ''
                        });
                        return;
                    },
        ...
        $('body').on('click', '#deleteuser', function() {
            ...
            let idku = $(this).attr('data-id');
            let url = '<?php echo url('privilege/fwd_access/deleteuserfwd'); ?>' + '/' + idku;
        ...
        $('body').on('click', '#detailuser', function() {
            ...
            $.ajax({
                url: "<?php echo url('privilege/fwd_access/detailuserfwd'); ?>",
                type: 'POST',
                dataType: 'json',
                data: {
                    _token: $('meta[name=csrf-token]').attr('content'),
...
<?php echo $__env->make('system::template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\forwarder\sources\Modules/System\Resources/views/settings/privileges/user_access_fwd.blade.php ENDPATH**/ ?>