    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var oTable = $('#serverside').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('list_approval')); ?>"
                },
                columns: [{
                        data: 'nomorpo',
                        name: 'nomorpo'
            ...
            $('body').on('click', '#prosesapproval', function() {
                ...
                $.ajax({
                    url: "<?php echo route('getdataapproval'); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: {
            ...
            $('#submittolak').click(function(e) {
                ...
                if (tolak == '' || tolak == null) {
                    ...
                    $.ajax({
                        url: "<?php echo route('approvalstatus', ['ditolak']); ?>",
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            _token: $('meta[name=csrf-token]').attr('content'),
                ...
                Swal.fire({
                    ...
                    .then((result) => {
                        if (result.dismiss == 'cancel') {
                            ...
                            $.ajax({
                                url: "<?php echo route('approvalstatus', ['disetujui']); ?>",
                                type: 'POST',
                                dataType: 'json',
                                data: {
                                    _token: $('meta[name=csrf-token]').attr('content'),
...
<?php echo $__env->make('system::template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\forwarder\sources\Modules/Transaksi\Resources/views/listapproval.blade.php ENDPATH**/ ?>