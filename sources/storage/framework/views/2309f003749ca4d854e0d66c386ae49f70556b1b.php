    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var tabel = $('#dataTables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(url('report/forwarder/search')); ?>",
                    data: function(d) {
                        d.po = $('#datapo').val()
                    }
                },
            ...
            $('#datapo').select2({
                ...
                ajax: {
                    url: "<?php echo url('report/forwarder/getpo'); ?>",
                    dataType: 'json',
                    delay: 500,
                    type: 'post',
            ...
            $('body').on('click', '#detailpo', function() {
                ...
                $.ajax({
                    url: "<?php echo route('report_detailforwarder'); ?>",
                    type: 'POST',
                    // dataType: 'json',
                    data: {
                        _token: $('meta[name=csrf-token]').attr('content'),
...
<?php echo $__env->make('system::template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\forwarder\sources\Modules/Report\Resources/views/reportforwarder.blade.php ENDPATH**/ ?>