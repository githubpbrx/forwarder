...
<body class="hold-transition login-page">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var datafwd = <?php echo json_encode($datafwd, 15, 512) ?>;
            ...
            $('#btnagree').click(function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo route('validasicocaction'); ?>",
                    data: {
...
<?php /**PATH D:\laragon\www\forwarder\sources\Modules/System\Resources/views/login/aktifasicoc.blade.php ENDPATH**/ ?>