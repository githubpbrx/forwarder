<div class="modal-body" style="font-size: 10pt;">
    <form action="#" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="shipmode" name="shipmode"
                            value="{{ $data['dataku'][0]['shipmode'] }}" readonly>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="fclvol" id="fclvol"
                                value="{{ $vol }}" autocomplete="off" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" name="fclweight" id="fclweight"
                                value="{{ $weight[0] }}" autocomplete="off" readonly>
                            <div class="input-group-append">
            ...
            @elseif ($data['dataku'][0]['shipmode'] == 'lcl')
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label">Volume</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="lclvol" id="lclvol"
                                value="{{ $expm3[0] }}" autocomplete="off" readonly>
                            <div class="input-group-append">
                                <span class="input-group-text">M3</span>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="lclweight" id="lclweight"
                                value="{{ $expkg[0] }}" autocomplete="off" readonly>
                            <div class="input-group-append">
                                <span class="input-group-text">Kg</span>
                            </div>
                        </div>
            ...
            @elseif ($data['dataku'][0]['shipmode'] == 'air')
                <div class="col-md-4">
                    <div class="form-group">
            ...
            @elseif ($data['dataku'][0]['shipmode'] == 'csfy')
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-12 control-label">Volume</label>
                        <div class="input-group">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text"
                            data-idpol="{{ $data['dataku'][0]['withportloading']->id_portloading }}"
                            class="form-control" id="portloading" name="portloading"
                            value="{{ $data['dataku'][0]['withportloading']->code_port . '-' . $data['dataku'][0]['withportloading']->name_port }}"
                            readonly>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text"
                            data-idpod="{{ $data['dataku'][0]['withportdestination']->id_portdestination }}"
                            class="form-control" id="portdestination" name="portdestination"
                            value="{{ $data['dataku'][0]['withportdestination']->code_port . '-' . $data['dataku'][0]['withportdestination']->name_port }}"
                            readonly>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="package" name="package"
                            value="{{ $data['dataku'][0]->package }}" autocomplete="off" readonly>
                    </div>
                </div>
            </div>
        </div>
