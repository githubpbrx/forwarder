                    ...
                    <div class="card-body">
                        ...
                        <div id="internalku">
                            <div class="form-group">
                                ...
                                <input value="" name="internalnik" type="text" class="form-control"
                                    id="internalnik" placeholder="masukkan nik">
                            </div>

                            <div class="form-group">
                                <label>Nama Karyawan</label>
                                <input value="" name="internalnama" type="text" class="form-control"
                                    id="internalnama" placeholder="nama" readonly>
                            </div>
                        </div>
                        ...
                        <div id="externalku">
                            <div class="form-group">
                                <label>Email</label>
                                <input value="" name="externalemail" type="text" class="form-control"
                                    id="externalemail" placeholder="masukkan email">
                            </div>

                            <div class="form-group">
                                <label>Nama</label>
                                <input value="" name="externalnama" type="text" class="form-control"
                                    id="externalnama" placeholder="masukkan nama">
                            </div>

                            <div class="form-group">
                                <label>NIK Validasi Finance</label>
                                <input value="" name="nikfinance" type="text" class="form-control" id="nikfinance"
                                    placeholder="NIK Finance">
                            </div>
                            <div class="form-group">
                                <label>Nama Finance</label>
                                <input value="" name="namafinance" type="text" class="form-control"
                                    id="namafinance" placeholder="nama Finance" readonly>
                            </div>
                            <div class="form-group">
                                <label>Email Finance</label>
                                <input value="" name="emailfinance" type="email" class="form-control"
                        ...
                        <input id="privilege-api-key" value="{{ $token }}" name="privilege_api_key" type="hidden"
