...
class SystemServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadMigrationsFrom(module_path('System', 'Database/Migrations'));
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('System', 'Resources/views');
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('System', 'Resources/lang'), 'system');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('System', 'Database/factories'));
        }
    }
