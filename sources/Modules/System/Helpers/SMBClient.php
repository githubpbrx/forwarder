...
class SMBClient
{
    ...
    public $_last_cmd_stdout; //private $_last_cmd_stdout;
    /**
    ...
    public $_last_cmd_stderr; //private $_last_cmd_stderr;
    /**
    ...
    private function execute ($cmd)
    {
        ...
        $outfile = tempnam(storage_path(), "cmd");
        $errfile = tempnam(storage_path(), "cmd");
