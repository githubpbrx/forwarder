...
class HistoryAllocation extends Controller
{
    ...
    {
        $data = array(
            'title' => 'History Allocation',
            'menu'  => 'historyallocation',
            'box'   => '',
        );

        \LogActivity::addToLog('Web Forwarder :: Forwarder : Access Menu History Allocation', $this->micro);
        return view('report::historyallocation', $data);
    }
    ...
    public function datatable(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = modelforwarder::join('po', 'po.id', 'forwarder.idpo')
                ...
                ->where('forwarder.aktif', 'Y')->where('masterforwarder.aktif', 'Y')
            ...
            return DataTables::of($data)
                ...
                //     $process    .= '<a href="#" data-id="' . $data->pono . '" id="detailalokasi"><i class="fa fa-info-circle"></i></a>';
