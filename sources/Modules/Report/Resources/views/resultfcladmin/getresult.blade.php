        ...
        @foreach ($master as $key => $item)
            ...
            <tr>
                ...
                @foreach ($fwd as $key2 => $item2)
                    <td>{{ $data[$item2->id_forwarder][$key]['of_20'] }}</td>
                    <td>{{ $data[$item2->id_forwarder][$key]['of_40'] }}</td>
                    <td>{{ $data[$item2->id_forwarder][$key]['of_40hc'] }}</td>
                    <td>{{ $data[$item2->id_forwarder][$key]['lb_20'] }}</td>
                    <td>{{ $data[$item2->id_forwarder][$key]['lb_40'] }}</td>
                    <td>{{ $data[$item2->id_forwarder][$key]['lb_40hc'] }}</td>
                @endforeach
